...
for (var i = 0; i < lati.length; i++) {
    ...
    L.marker([lati[i], longi[i]], { icon: customIcon }).addTo(map).bindPopup("<center><img src='../K/icon.png' width='30px' height='30px'></center>"+"<br>"+"<b>Usuario: </b>"+ user[i]+"<br>"+"<b>Tipo de accidente: </b>"+p1[i]+"<br>"+"<b>Presencia de muertos: </b>"+p2[i]).openPopup();
