  ...
  <a class="navbar-brand" href="index.php">
	...
	<form action="ValidarAdmin.php" method="POST">
	  <div class="formulario">
	    <h1 class="titulo-form">Login | Admin</h1>
		  <input type="text" placeholder="Usuario" class="inputs-inserts" name="usuario">
		  <input type="password" placeholder="Contraseña" class="inputs-inserts" name="contra">
		  <input type="submit" value="Login" class="btn-env" name="login">
